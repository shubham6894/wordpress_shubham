			...
			<div id="carouselIndicators" class="carousel slide"  data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree1.jpg");?>" alt="First slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 1.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree2.jpg");?>" alt="Second slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 2.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree3.jpg");?>"="RSVP_IMAGES/soiree3.jpg" alt="Third slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 3.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree4.jpg");?>"="RSVP_IMAGES/soiree4.jpg" alt="fourth slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 4.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree5.jpg");?>"="RSVP_IMAGES/soiree5.jpg" alt="fifth slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 5.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree7.jpg");?>"="RSVP_IMAGES/soiree7.jpg" alt="seventh slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 7.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree8.jpg");?>"="RSVP_IMAGES/soiree8.jpg" alt="eighth slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 8.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree9.jpg");?>"="RSVP_IMAGES/soiree9.jpg" alt="ninth slide">
						<div class="carousel-caption d-none d-md-block">#SOIREE 9.</div>
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid images-carousel" src="<?php echo esc_url(get_template_directory_uri()."/dist/img/soiree11.jpg");?>"="RSVP_IMAGES/soiree11.jpg" alt="eleventh slide">
