				...
				<form id="request_form">
					<div class="modal-body">
						...
						<div class="form-group">
							<label for=requested_guest_name" class="form-control-label">Your Name:</label>
							<input type="text" class="form-control" name="requested_guest_name" id="requested_guest_name" maxlength="30" required="required">  
						</div>
						<div class="form-group">
							<label for="requested_guest_email" class="form-control-label">Your Email:</label>   
						...
						<div class="form-group">
							<label for="requested_guest_number" class="form-control-label">Mobile Number:</label>
